...
export default function MacbookFeatures(props) {
  const { color, texture } = useProductStore()
  ...
  // Applica il colore alle parti del modello
  useEffect(() => {
...
// Esporta i video refs per l'uso nel componente Features
export { }
